...
const CustomerSupport = () => {
  ...
  //   query {
  //     support: file(relativePath: { eq: "pbl.svg" }) {
  //       childImageSharp {
  ...
  console.log(support);
  return (
    <Box as="section" sx={styles.section} id='programs'>
      <Container>
        <Box sx={styles.grid}>
          ...
          <Box sx={styles.content}>
            ...
            Project-Based Learning (PBL) Program: Transform Knowledge into Real-World Projects
            </Heading>
